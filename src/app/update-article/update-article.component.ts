...
export class UpdateArticleComponent implements OnInit {
  ...
  this.articleCourant.libelle+":"+this.articleCourant.prix+"DT, qté="+ this.articleCourant.qte+", ajoutée le "+this.articleCourant.dateAjout);
  ...
  console.log("code article à modifier "+this.articleCourant.code);
